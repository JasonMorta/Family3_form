...
const translations = {
  en: {
    ...
    fields: {
      fullName: 'Full name and surname', birthDate: 'Birth date', nickname: 'Nickname or preferred name', prefix: 'Title or prefix', maidenName: 'Maiden name or birth surname',
    ...
    status: {
      ...
      duplicateTitle: 'This person already exists.', duplicateStopped: 'A person with this full name already exists in Firebase. Submission stopped.',
      duplicateName: 'Name',
