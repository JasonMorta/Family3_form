...
const translations = {
  en: {
    ...
    steps: {
      step1: { kicker: 'Step 1', title: 'Basic details', desc: 'Add your main details. Only your full name and birth date are required.' },
      step2: { kicker: 'Step 2', title: 'Main photo', desc: 'Add a clear photo of yourself. You can crop it before saving.' },
      step3: { kicker: 'Step 3', title: 'Life details', desc: 'Add simple details about your life, like dates, places, work, and school.' },
      step4: { kicker: 'Step 4', title: 'Story and memories', desc: 'Add simple notes about yourself, like what you are like, what you enjoy, and what matters most to you.' },
      step5: { kicker: 'Step 5', title: 'Parents', desc: 'Add your parents or the people who raised you.' },
      step6: { kicker: 'Step 6', title: 'Children', desc: 'Add your children here. Keep it simple.' },
      step7: { kicker: 'Step 7', title: 'Siblings and notes', desc: 'Add your brothers, sisters, and any extra family notes.' },
      step8: { kicker: 'Step 8', title: 'Partner details', desc: 'Choose relationship status and add husband, wife, or partner details if needed.' },
    ...
    fields: {
      fullName: 'Full name and surname', birthDate: 'Birth date', nickname: 'Nickname or chosen name', prefix: 'Title', maidenName: 'Birth surname',
      gender: 'Gender', birthPlace: 'Place of birth', stillAlive: 'Still alive?', deathDate: 'Date of death', deathPlace: 'Place of death', currentLocation: 'Current town or city',
      heritage: 'Nationality or heritage', occupation: 'Work or occupation', education: 'School, study, or training', maritalStatus: 'Relationship status', languages: 'Languages spoken',
      biography: 'About you', achievements: 'Important life moments', interests: 'Likes and hobbies', personality: 'What you are like', familyNotes: 'Extra family notes',
    ...
    placeholders: {
      prefix: 'Mr, Mrs, Dr', place: 'Town, city, or country', currentLocation: 'Where you live now', heritage: 'South African, British, Xhosa, etc.',
      education: 'School, college, trade, or training', languages: 'Use commas between names',
      biography: 'Write a few simple lines about yourself.', achievements: 'Big moments, proud moments, or important things you did.',
      interests: 'Things you like to do, watch, make, collect, or talk about.', personality: 'Words that show what you are like, such as kind, funny, quiet, or strong.',
      familyNotes: 'Anything else the family should know.',
    },
    help: {
      biography: 'Write a few simple lines. You can say who you are, what kind of person you are, and what matters most to you.',
      achievements: 'Examples: a job you were proud of, moving to a new place, raising children, helping others, winning something, or any big moment.',
      interests: 'Examples: music, church, soccer, cooking, farming, sewing, fixing things, reading, or spending time with family.',
      personality: 'Examples: kind, funny, shy, strict, calm, hard-working, always smiling, loving to sing, or always telling jokes.',
      familyNotes: 'Add anything else that may help your family understand you better.',
  ...
  af: {
    ...
    steps: {
      step1: { kicker: 'Stap 1', title: 'Basiese besonderhede', desc: 'Vul jou hoof besonderhede in. Net jou volle naam en geboortedatum is verpligtend.' },
      step2: { kicker: 'Stap 2', title: 'Hooffoto', desc: 'Voeg ’n duidelike foto van jouself by. Jy kan dit sny voor dit gestoor word.' },
      step3: { kicker: 'Stap 3', title: 'Lewensbesonderhede', desc: 'Voeg eenvoudige besonderhede oor jou lewe by, soos datums, plekke, werk en skool.' },
      step4: { kicker: 'Stap 4', title: 'Verhaal en herinneringe', desc: 'Voeg eenvoudige notas oor jouself by, soos hoe jy is, waarvan jy hou, en wat vir jou belangrik is.' },
      step5: { kicker: 'Stap 5', title: 'Ouers', desc: 'Voeg jou ouers of die mense by wat jou grootgemaak het.' },
      step6: { kicker: 'Stap 6', title: 'Kinders', desc: 'Voeg jou kinders hier by. Hou dit eenvoudig.' },
      step7: { kicker: 'Stap 7', title: 'Broers, susters en notas', desc: 'Voeg jou broers, susters en enige ekstra familienotas by.' },
      step8: { kicker: 'Stap 8', title: 'Maat besonderhede', desc: 'Kies verhoudingstatus en voeg man, vrou of maatbesonderhede by as dit nodig is.' },
    ...
    fields: {
      ...
      biography: 'Oor jou', achievements: 'Belangrike lewensoomblikke', interests: 'Hou van en stokperdjies', personality: 'Hoe jy is', familyNotes: 'Ekstra familienotas',
      relationshipName: 'Volle naam', relationshipBirthDate: 'Geboortedatum', relationshipPhoto: 'Foto', partnerType: 'Tipe maat',
    },
    placeholders: {
      prefix: 'Mnr, Mev, Dr', place: 'Dorp, stad of land', currentLocation: 'Waar jy nou woon', heritage: 'Suid-Afrikaans, Brits, Xhosa, ens.',
      education: 'Skool, kollege, ambag of opleiding', languages: 'Gebruik kommas tussen name',
      biography: 'Skryf ’n paar eenvoudige lyne oor jouself.', achievements: 'Groot oomblikke, trotse oomblikke, of belangrike dinge wat jy gedoen het.',
      interests: 'Dinge waarvan jy hou om te doen, kyk, maak, versamel of oor te praat.', personality: 'Woorde wat wys hoe jy is, soos vriendelik, snaaks, stil, of sterk.',
      familyNotes: 'Enigiets anders wat die familie moet weet.',
    },
    help: {
      biography: 'Skryf ’n paar eenvoudige lyne. Jy kan sê wie jy is, watter soort mens jy is, en wat vir jou die belangrikste is.',
      achievements: 'Voorbeelde: werk waarop jy trots was, trek na ’n nuwe plek, kinders grootmaak, ander help, iets wen, of enige groot oomblik.',
      interests: 'Voorbeelde: musiek, kerk, sokker, kosmaak, boer, naaldwerk, dinge regmaak, lees, of tyd saam met familie.',
      personality: 'Voorbeelde: vriendelik, snaaks, skaam, streng, rustig, hardwerkend, altyd glimlaggend, lief vir sing, of het altyd grappies vertel.',
      familyNotes: 'Voeg enigiets anders by wat die familie kan help om jou beter te verstaan.',
